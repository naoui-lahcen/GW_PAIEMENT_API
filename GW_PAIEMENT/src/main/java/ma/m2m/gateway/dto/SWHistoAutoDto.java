...
public class SWHistoAutoDto {
	...
	public SWHistoAutoDto(int hat_numdem, String hat_numcmr, String hat_mcc, Date hat_datdem, String hat_herdem,
			String hat_codtpe, String hat_porteur, Double hat_montant, String hat_devise, String hat_coderep,
			String hat_nautsrv, String hat_ncompte, String hat_nautemt, String hat_codtrns, String hat_nrefce,
			String hat_mtfref1, String hat_mtfref2, String hat_procode, String hat_reasreq, String hat_anomalie,
			String hat_instance, String hat_appelbqe, String hat_codpay, String hat_demandeur, String hat_repondeur,
			String hat_nomdeandeur, String hat_typproto, String hat_etat, String hat_expdate, String hat_bqecmr,
			String hat_aip, String hat_atc, String hat_ac, String hat_cid, String hat_cvmres, String hat_sernum,
			String hat_iad, String hat_termcapab, String hat_termtyp, String hat_tvr, String hat_un, String hat_mntaut,
			String hat_mntoth, Date hat_appeffdat, Date hat_appexpdat, String hat_pansn, String hat_pin,
			String hat_panmod, String hat_tercoucod, String hat_codedevise, Date hat_trsdate, String hat_trstyp,
			String hat_issauth, String hat_issscript) {
		super();
		this.hat_numdem = hat_numdem;
		this.hat_numcmr = hat_numcmr;
		this.hat_mcc = hat_mcc;
	...
	public SWHistoAutoDto() {
		super();
	}

	@Override
	public String toString() {
		return "SWHistoAutoDto [hat_numdem=" + hat_numdem + ", hat_numcmr=" + hat_numcmr + ", hat_mcc=" + hat_mcc
